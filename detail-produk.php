    ...
    <header>
        <div class="container">
            <div class="header-logo">
             <a href="index.php"><img src="https://storage.googleapis.com/tokoku/assets/logo.png" href="dashboard.php" class="logo">
             </a>
            </div>
            <ul>
        ...
        <div class="container"> 
            ...
            <div class="box">
                ...
                <div class="col-2">
                    ...
                    <h3 class="wa">Hubungi Via Whatsapp</h3>
                    <a href="https://api.whatsapp.com/send?phone=<?php echo $a->admin_telp ?>&text=Hai, saya tertarik dengan produk Anda" target="_blank">
                        <img class="logowa"src="https://storage.googleapis.com/tokoku/assets/logo%20wa.png" width="50px"></a>
                </div>
            </div>
        </div>
    </div>
